...
# Connect L2 cache directly to memory bus (no L3)
...
print("Configuration: L1 + L2 CACHE (no L3)")
...
# Function to extract cache stats for L1 + L2 only
...
def calculate_cache_ratios(cache_stats):
    ratios = {}
    cache_types = ['icache', 'dcache', 'l2cache']  # no l3cache now
...
print("\n=== ARM64 L1 + L2 CACHE STATISTICS FROM stats.txt ===")
